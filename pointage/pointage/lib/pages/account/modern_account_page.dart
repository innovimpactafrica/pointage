...
class ModernAccountPage extends StatefulWidget {
  ...
  @override
  State<ModernAccountPage> createState() => _ModernAccountPageState();
}
...
class _ModernAccountPageState extends State<ModernAccountPage> {
    ...
    try {
      ...
      if (mounted) {
        Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (context) => const PointageLoginPage()),
          (route) => false,
        );
      }
    } catch (e) {
  ...
  void _navigateToLogin(BuildContext context) async {
    ...
    Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (context) => const PointageLoginPage()));
  }
